...
class LavenderTUI(App):
    ...
    def show_discord_help(self, chat: RichLog):
        ...
        chat.write("!scan_tags <count> — Save recent tagged messages, skipping exact duplicates")
        ...
        chat.write("!prune — Delete unfavourited pictures and prune duplicate notes")
        chat.write("")
        chat.write("Pictures:")
